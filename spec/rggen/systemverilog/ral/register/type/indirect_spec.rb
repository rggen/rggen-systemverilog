  ...
  describe '#constructors' do
    it 'レジスタモデルの生成と構成を行うコードを出力する' do
      ...
      expect(code_block).to match_string(<<~'CODE')
        `rggen_ral_create_reg_model(register_4, '{}, 8'h10, "RW", "g_register_4.u_register")
        `rggen_ral_create_reg_model(register_5[0], '{0}, 8'h14, "RW", "g_register_5.g[0].u_register")
        `rggen_ral_create_reg_model(register_5[1], '{1}, 8'h14, "RW", "g_register_5.g[1].u_register")
        `rggen_ral_create_reg_model(register_6[0][0], '{0, 0}, 8'h18, "RW", "g_register_6.g[0].g[0].u_register")
        `rggen_ral_create_reg_model(register_6[0][1], '{0, 1}, 8'h18, "RW", "g_register_6.g[0].g[1].u_register")
        `rggen_ral_create_reg_model(register_6[0][2], '{0, 2}, 8'h18, "RW", "g_register_6.g[0].g[2].u_register")
        `rggen_ral_create_reg_model(register_6[0][3], '{0, 3}, 8'h18, "RW", "g_register_6.g[0].g[3].u_register")
        `rggen_ral_create_reg_model(register_6[1][0], '{1, 0}, 8'h18, "RW", "g_register_6.g[1].g[0].u_register")
        `rggen_ral_create_reg_model(register_6[1][1], '{1, 1}, 8'h18, "RW", "g_register_6.g[1].g[1].u_register")
        `rggen_ral_create_reg_model(register_6[1][2], '{1, 2}, 8'h18, "RW", "g_register_6.g[1].g[2].u_register")
        `rggen_ral_create_reg_model(register_6[1][3], '{1, 3}, 8'h18, "RW", "g_register_6.g[1].g[3].u_register")
        `rggen_ral_create_reg_model(register_7[0][0], '{0, 0}, 8'h1c, "RW", "g_register_7.g[0].g[0].u_register")
        `rggen_ral_create_reg_model(register_7[0][1], '{0, 1}, 8'h1c, "RW", "g_register_7.g[0].g[1].u_register")
        `rggen_ral_create_reg_model(register_7[0][2], '{0, 2}, 8'h1c, "RW", "g_register_7.g[0].g[2].u_register")
        `rggen_ral_create_reg_model(register_7[0][3], '{0, 3}, 8'h1c, "RW", "g_register_7.g[0].g[3].u_register")
        `rggen_ral_create_reg_model(register_7[1][0], '{1, 0}, 8'h1c, "RW", "g_register_7.g[1].g[0].u_register")
        `rggen_ral_create_reg_model(register_7[1][1], '{1, 1}, 8'h1c, "RW", "g_register_7.g[1].g[1].u_register")
        `rggen_ral_create_reg_model(register_7[1][2], '{1, 2}, 8'h1c, "RW", "g_register_7.g[1].g[2].u_register")
        `rggen_ral_create_reg_model(register_7[1][3], '{1, 3}, 8'h1c, "RW", "g_register_7.g[1].g[3].u_register")
        `rggen_ral_create_reg_model(register_8, '{}, 8'h20, "RO", "g_register_8.u_register")
        `rggen_ral_create_reg_model(register_9, '{}, 8'h24, "WO", "g_register_9.u_register")
        `rggen_ral_create_reg_model(register_10[0], '{0}, 8'h28, "RW", "g_register_10.g[0].u_register")
        `rggen_ral_create_reg_model(register_10[1], '{1}, 8'h28, "RW", "g_register_10.g[1].u_register")
        `rggen_ral_create_reg_model(register_0[0][0], '{0, 0}, 8'h00, "RW", "g_register_0.g[0].g[0].u_register")
        `rggen_ral_create_reg_model(register_0[0][1], '{0, 1}, 8'h00, "RW", "g_register_0.g[0].g[1].u_register")
        `rggen_ral_create_reg_model(register_0[1][0], '{1, 0}, 8'h00, "RW", "g_register_0.g[1].g[0].u_register")
        `rggen_ral_create_reg_model(register_0[1][1], '{1, 1}, 8'h00, "RW", "g_register_0.g[1].g[1].u_register")
        `rggen_ral_create_reg_model(register_0[0][0], '{0, 0}, 8'h00, "RW", "g_register_0.g[0].g[0].u_register")
        `rggen_ral_create_reg_model(register_0[0][1], '{0, 1}, 8'h00, "RW", "g_register_0.g[0].g[1].u_register")
        `rggen_ral_create_reg_model(register_0[1][0], '{1, 0}, 8'h00, "RW", "g_register_0.g[1].g[0].u_register")
        `rggen_ral_create_reg_model(register_0[1][1], '{1, 1}, 8'h00, "RW", "g_register_0.g[1].g[1].u_register")
