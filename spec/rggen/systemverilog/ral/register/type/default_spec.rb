  ...
  describe '#constructors' do
    it 'レジスタモデルの生成と構成を行うコードを出力する' do
      ...
      expect(code_block).to match_string(<<~'CODE')
        ...
        `rggen_ral_create_reg(register_3[0], '{0}, 8'h30, "RW", "g_register_3.g[0].u_register")
        `rggen_ral_create_reg(register_3[1], '{1}, 8'h38, "RW", "g_register_3.g[1].u_register")
    ...
    it 'レジスタレベルのRALモデルの定義を出力する' do
      ...
      expect(registers[10]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_10_reg_model extends rggen_ral_reg;
          ...
          function void build();
            `rggen_ral_create_field(register_10, 0, 1, "RW", 0, 1'h0, 1, -1, "")
          endfunction
        endclass
      CODE
      ...
      expect(registers[12]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_file_12_register_file_0_register_0_reg_model extends rggen_ral_reg;
          ...
          function void build();
            `rggen_ral_create_field(bit_field_0, 0, 1, "RW", 0, 1'h0, 1, -1, "")
            `rggen_ral_create_field(bit_field_1, 1, 1, "RO", 1, 1'h0, 0, -1, "register_file_12.register_file_0.register_0.bit_field_0")
          endfunction
        endclass
      CODE
