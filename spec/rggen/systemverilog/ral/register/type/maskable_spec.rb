  ...
  let(:registers) do
    sv_ral = create_sv_ral do
      ...
      register do
        ...
        offset_address 0x50
        type :maskable
        bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 4; type :rw; initial_value 0 }
      end
  ...
  describe '#generate_code' do
    it 'レジスタレベルのRALモデルの定義を出力する' do
      expect(registers[0]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_0_reg_model extends rggen_ral_maskable_reg;
      ...
      expect(registers[1]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_1_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[2]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_2_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[3]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_3_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[4]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_4_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[5]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_5_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0[4];
          function new(string name);
            super.new(name, 32, 0);
          endfunction
          function void build();
            `rggen_ral_create_field(bit_field_0[0], 0, 4, "RW", 0, 4'h0, '{}, 1, 0, 4, "")
            `rggen_ral_create_field(bit_field_0[1], 4, 4, "RW", 0, 4'h0, '{}, 1, 1, 4, "")
            `rggen_ral_create_field(bit_field_0[2], 8, 4, "RW", 0, 4'h0, '{}, 1, 2, 4, "")
            `rggen_ral_create_field(bit_field_0[3], 12, 4, "RW", 0, 4'h0, '{}, 1, 3, 4, "")
          endfunction
        endclass
      CODE

      expect(registers[6]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_6_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 64, 0);
          endfunction
      ...
      expect(registers[7]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_7_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0[2];
          function new(string name);
            super.new(name, 64, 0);
          endfunction
          function void build();
            `rggen_ral_create_field(bit_field_0[0], 4, 4, "RW", 0, 4'h0, '{}, 1, 0, 2, "")
            `rggen_ral_create_field(bit_field_0[1], 36, 4, "RW", 0, 4'h0, '{}, 1, 1, 2, "")
          endfunction
        endclass
      CODE

      expect(registers[8]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_8_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[9]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_9_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[10]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_10_reg_model extends rggen_ral_maskable_reg;
      ...
      expect(registers[11]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_file_11_register_0_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
      ...
      expect(registers[12]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_file_12_register_file_0_register_0_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
      ...
      expect(registers[13]).to generate_code(:ral_package, :bottom_up, <<~'CODE')
        class register_file_13_register_file_0_register_0_reg_model extends rggen_ral_maskable_reg;
          rand rggen_ral_field bit_field_0;
          function new(string name);
            super.new(name, 32, 0);
          endfunction
