  ...
  describe '#constructors' do
    ...
    it 'フィールドモデルの生成と構成を行うコードを出力する' do
      ...
      expect(code_block).to match_string(<<~'CODE')
        `rggen_ral_create_field(bit_field_0, 0, 1, "FOO", 1, 1'h0, 0, 0, "")
        `rggen_ral_create_field(bit_field_1, 8, 8, "FOO", 1, 8'h00, 0, 0, "")
        `rggen_ral_create_field(bit_field_2, 16, 1, "FOO", 1, 1'h0, 1, 0, "")
        `rggen_ral_create_field(bit_field_3, 24, 8, "FOO", 1, 8'hab, 1, 0, "")
        `rggen_ral_create_field(bit_field_0, 0, 1, "BAR", 0, 1'h0, 0, 0, "")
        `rggen_ral_create_field(bit_field_1, 1, 1, "RW", 1, 1'h0, 0, 0, "")
        ...
        `rggen_ral_create_field(register_3, 0, 1, "FOO", 1, 1'h0, 0, 0, "")
        `rggen_ral_create_field(bit_field_0, 0, 1, "FOO", 1, 1'h0, 0, 0, "")
        ...
        `rggen_ral_create_field(bit_field_0, 0, 1, "FOO", 1, 1'h0, 0, 0, "register_0.bit_field_0")
        ...
        `rggen_ral_create_field(bit_field_2, 8, 1, "FOO", 1, 1'h0, 0, 0, "register_3.register_3")
        `rggen_ral_create_field(bit_field_0, 0, 1, "FOO", 1, 1'h0, 0, 0, "register_file_3.register_0.bit_field_0")
