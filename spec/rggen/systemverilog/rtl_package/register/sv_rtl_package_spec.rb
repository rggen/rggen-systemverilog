  ...
  describe 'パラメータ定義' do
    it 'バイト幅/バイト長/配列長/オフセットアドレスを示すパラメータを定義する' do
      ...
      expect(sv_rtl_package[6]).to have_parameter(
        ...
        data_type: :bit, width: 8, array_size: [2], array_format: :unpacked, default: "'{8'h30, 8'h38}"
      )
      ...
      expect(sv_rtl_package[7]).to have_parameter(
        ...
        data_type: :bit, width: 8, array_size: [4], array_format: :unpacked, default: "'{8'h40, 8'h40, 8'h40, 8'h40}"
      )
      ...
      expect(sv_rtl_package[8]).to have_parameter(
        :register_block, :__array_size,
        name: 'REGISTER_8_ARRAY_SIZE', parameter_type: :localparam,
        data_type: :int, array_size: [2], array_format: :unpacked, default: "'{2, 2}"
      )
      expect(sv_rtl_package[8]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_8_BYTE_OFFSET', parameter_type: :localparam,
        data_type: :bit, width: 8, array_size: [2, 2], array_format: :unpacked, default: "'{'{8'h44, 8'h44}, '{8'h44, 8'h44}}"
      )

      expect(sv_rtl_package[9]).to have_parameter(
        :register_block, :__byte_width,
        name: 'REGISTER_9_BYTE_WIDTH', parameter_type: :localparam,
        data_type: :int, default: 4
      )
      expect(sv_rtl_package[9]).to have_parameter(
        :register_block, :__byte_size,
        name: 'REGISTER_9_BYTE_SIZE', parameter_type: :localparam,
        data_type: :int, default: 16
      )
      expect(sv_rtl_package[9]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_9_BYTE_OFFSET', parameter_type: :localparam,
      ...
      expect(sv_rtl_package[12]).to have_parameter(
        ...
        data_type: :bit, width: 8, default: "8'h70"
      )
      ...
      expect(sv_rtl_package[13]).to have_parameter(
        ...
        data_type: :bit, width: 8, array_size: [2], array_format: :unpacked, default: "'{8'h78, 8'h7c}"
      )

      expect(sv_rtl_package[14]).to have_parameter(
        :register_block, :__byte_width,
        name: 'REGISTER_FILE_11_REGISTER_11_0_BYTE_WIDTH', parameter_type: :localparam,
        data_type: :int, default: 4
      )
      expect(sv_rtl_package[14]).to have_parameter(
        :register_block, :__byte_size,
        name: 'REGISTER_FILE_11_REGISTER_11_0_BYTE_SIZE', parameter_type: :localparam,
        data_type: :int, default: 16
      )
      expect(sv_rtl_package[14]).to have_parameter(
        :register_block, :__array_size,
        name: 'REGISTER_FILE_11_REGISTER_11_0_ARRAY_SIZE', parameter_type: :localparam,
        data_type: :int, array_size: [2], array_format: :unpacked, default: "'{2, 2}"
      )
      expect(sv_rtl_package[14]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_FILE_11_REGISTER_11_0_BYTE_OFFSET', parameter_type: :localparam,
      ...
      expect(sv_rtl_package[15]).to have_parameter(
        :register_block, :__byte_width,
        name: 'REGISTER_FILE_11_REGISTER_11_1_BYTE_WIDTH', parameter_type: :localparam,
        data_type: :int, default: 4
      )
      expect(sv_rtl_package[15]).to have_parameter(
        :register_block, :__byte_size,
        name: 'REGISTER_FILE_11_REGISTER_11_1_BYTE_SIZE', parameter_type: :localparam,
        data_type: :int, default: 32
      )
      expect(sv_rtl_package[15]).to have_parameter(
        :register_block, :__array_size,
        name: 'REGISTER_FILE_11_REGISTER_11_1_ARRAY_SIZE', parameter_type: :localparam,
        data_type: :int, array_size: [3], array_format: :unpacked, default: "'{2, 2, 2}"
      )
      expect(sv_rtl_package[15]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_FILE_11_REGISTER_11_1_BYTE_OFFSET', parameter_type: :localparam,
      ...
      expect(sv_rtl_package[16]).to have_parameter(
        :register_block, :__byte_width,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_0_BYTE_WIDTH', parameter_type: :localparam,
        data_type: :int, default: 4
      )
      expect(sv_rtl_package[16]).to have_parameter(
        :register_block, :__byte_size,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_0_BYTE_SIZE', parameter_type: :localparam,
        data_type: :int, default: 16
      )
      expect(sv_rtl_package[16]).to have_parameter(
        :register_block, :__array_size,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_0_ARRAY_SIZE', parameter_type: :localparam,
        data_type: :int, array_size: [2], array_format: :unpacked, default: "'{2, 2}"
      )
      expect(sv_rtl_package[16]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_0_BYTE_OFFSET', parameter_type: :localparam,
        data_type: :bit, width: 8, array_size: [2, 2], array_format: :unpacked, default: "'{'{8'h90, 8'hb0}, '{8'hd0, 8'hf0}}"
      )

      expect(sv_rtl_package[17]).to have_parameter(
        :register_block, :__byte_width,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_1_BYTE_WIDTH', parameter_type: :localparam,
        data_type: :int, default: 4
      )
      expect(sv_rtl_package[17]).to have_parameter(
        :register_block, :__byte_size,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_1_BYTE_SIZE', parameter_type: :localparam,
        data_type: :int, default: 32
      )
      expect(sv_rtl_package[17]).to have_parameter(
        :register_block, :__array_size,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_1_ARRAY_SIZE', parameter_type: :localparam,
        data_type: :int, array_size: [3], array_format: :unpacked, default: "'{2, 2, 2}"
      )
      expect(sv_rtl_package[17]).to have_parameter(
        :register_block, :__offset,
        name: 'REGISTER_FILE_11_REGISTER_FILE_11_2_REGISTER_11_2_1_BYTE_OFFSET', parameter_type: :localparam,
        data_type: :bit, width: 8, array_size: [2, 2, 2], array_format: :unpacked, default: "'{'{'{8'h98, 8'h9c}, '{8'hb8, 8'hbc}}, '{'{8'hd8, 8'hdc}, '{8'hf8, 8'hfc}}}"
      )
    end
  end
end
