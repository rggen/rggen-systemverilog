...
RSpec.describe 'bit_field/type/woc' do
  ...
  describe '#generate_code' do
    ...
    it 'rggen_bit_field_woc_woをインスタンスするコードを出力する' do
      bit_fields = create_bit_fields do
        byte_size 256
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :woc; initial_value 0 }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 16, width: 16; type :woc; initial_value 0xabcd }
        end
