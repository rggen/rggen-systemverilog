...
RSpec.describe 'register/type/maskable' do
  ...
  describe '#generate_code' do
    ...
    it 'rggen_maskable_registerをインスタンスするコードを生成する' do
      ...
      expect(registers[5]).to generate_code(:register, :top_down, <<~'CODE')
        `rggen_tie_off_unused_signals(32, 32'h0000f0f0, bit_field_if)
        rggen_maskable_register #(
          .READABLE       (1),
          .WRITABLE       (1),
          .ADDRESS_WIDTH  (10),
      ...
      expect(registers[7]).to generate_code(:register, :top_down, <<~'CODE')
        `rggen_tie_off_unused_signals(64, 64'h000000f0000000f0, bit_field_if)
        rggen_maskable_register #(
          .READABLE       (1),
          .WRITABLE       (1),
          .ADDRESS_WIDTH  (10),
